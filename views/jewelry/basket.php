            ...
            <div class="container">
                ...
                <div class="col-md-9" id="basket">
                    ...
                    <div class="box">
                        ...
                        <form method="post" action="<?php echo base_url('jewelry/checkout1') ?>">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <a href="#">
                                                    <img src="<?php echo base_url();?>assets/home-css/img/earring1.jpg" alt="White Blouse Armani">
                                                </a>
                                            </td>
                                            <td><a href="#">Beaded Jhumka Style Layered Earrings</a>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="#">
                                                    <img src="<?php echo base_url();?>assets/home-css/img/earring2.jpg" alt="Black Blouse Armani">
                                                </a>
                                            </td>
                                            <td><a href="#">Beaded Jhumka Style Layered Earrings</a>
                                            </td>
                            ...
                            <div class="box-footer">
                                <div class="pull-left">
                                    <a href="<?php echo base_url('jewelry/bridal_wear');?>" class="btn btn-default"><i class="fa fa-chevron-left"></i> Continue shopping</a>
                                </div>
                    ...
                    <div class="row same-height-row">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="product same-height">
                                ...
                                <div class="text">
                                    <h3>Beaded Jhumka Style Layered Earrings</h3>
                                    <p class="price">$143</p>
                                </div>
                            </div>
                            <!-- /.product -->
