                                    ...
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="<?php echo base_url('jewelry/detail'); ?>">
                                                <img src="<?php echo base_url(); ?>assets/home-css/img/bangle1.jpg" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="<?php echo base_url('jewelry/detail'); ?>">
                            ...
                            <div class="product">
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="<?php echo base_url('jewelry/detail'); ?>">
                                                <img src="<?php echo base_url(); ?>assets/home-css/img/bangle2.jpg" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="<?php echo base_url('jewelry/detail'); ?>">
                            ...
                            <div class="product">
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="<?php echo base_url('jewelry/detail'); ?>">
                                                <img src="<?php echo base_url(); ?>assets/home-css/img/bangle3.jpg" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="<?php echo base_url('jewelry/detail'); ?>">
                            ...
                            <div class="product">
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="<?php echo base_url('jewelry/detail'); ?>">
                                                <img src="<?php echo base_url(); ?>assets/home-css/img/bangle4.jpg" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="<?php echo base_url('jewelry/detail'); ?>">
                            ...
                            <div class="product">
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="<?php echo base_url('jewelry/detail'); ?>">
                                                <img src="<?php echo base_url(); ?>assets/home-css/img/bangle5.jpg" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="<?php echo base_url('jewelry/detail'); ?>">
                            ...
                            <div class="product">
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="<?php echo base_url('jewelry/detail'); ?>">
                                                <img src="<?php echo base_url(); ?>assets/home-css/img/bangle6.jpg" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="<?php echo base_url('jewelry/detail'); ?>">
