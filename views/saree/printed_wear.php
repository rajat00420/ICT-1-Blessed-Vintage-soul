                        ...
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked category-menu">
                                ...
                                <li class="active">
                                    ...
                                    <ul>
                                        <li><a href="<?php echo base_url('saree/printed_wear');?>">Printed</a>
                                        </li>
                                    ...
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="<?php echo base_url('saree/detail')?>">
                                                <img src="<?php echo base_url();?>assets/home-css/img/printed1.jpg" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="<?php echo base_url('saree/detail')?>">
                            ...
                            <div class="product">
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="<?php echo base_url('saree/detail')?>">
                                                <img src="<?php echo base_url();?>assets/home-css/img/printed2.jpg" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="<?php echo base_url('saree/detail')?>">
                            ...
                            <div class="product">
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="<?php echo base_url('saree/detail')?>">
                                                <img src="<?php echo base_url();?>assets/home-css/img/printed3.jpg" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="<?php echo base_url('saree/detail')?>">
                            ...
                            <div class="product">
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="<?php echo base_url('saree/detail')?>">
                                                <img src="<?php echo base_url();?>assets/home-css/img/printed4.jpg" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="<?php echo base_url('saree/detail')?>">
                            ...
                            <div class="product">
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="<?php echo base_url('saree/detail')?>">
                                                <img src="<?php echo base_url();?>assets/home-css/img/printed5.jpg" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="<?php echo base_url('saree/detail')?>">
                            ...
                            <div class="product">
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="<?php echo base_url('saree/detail')?>">
                                                <img src="<?php echo base_url();?>assets/home-css/img/printed6.jpg" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="<?php echo base_url('saree/detail')?>">
