            ...
            <div class="container">
                ...
                <div class="col-md-9" id="basket">
                    ...
                    <div class="box">
                        ...
                        <form method="post" action="<?php echo base_url('saree/checkout1') ?>">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <a href="#">
                                                    <img src="<?php echo base_url();?>assets/home-css/img/party1.jpg" alt="White Blouse Armani">
                                                </a>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="#">
                                                    <img src="<?php echo base_url();?>assets/home-css/img/party2.jpg" alt="Black Blouse Armani">
                                                </a>
                                            </td>
                            ...
                            <div class="box-footer">
                                <div class="pull-left">
                                    <a href="<?php echo base_url('saree/bridal_wear');?>" class="btn btn-default"><i class="fa fa-chevron-left"></i> Continue shopping</a>
                                </div>
